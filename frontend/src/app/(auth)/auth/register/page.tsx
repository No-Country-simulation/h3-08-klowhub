...
function AuthRegisterPage() {
  return (
    <main className='relative grid grow px-6 py-9 before:absolute before:inset-0 before:-z-10 before:bg-primary-900/25 before:backdrop-blur-lg lg:grid-cols-2 lg:p-0 lg:before:bg-transparent lg:before:backdrop-blur-none'>
