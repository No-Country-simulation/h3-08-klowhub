import { MyCoursesList } from '@/app/(platform)/components/list/my-courses-list'
import { CourseProgressSection } from '@/app/(platform)/components/section/course-progress-section'
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
