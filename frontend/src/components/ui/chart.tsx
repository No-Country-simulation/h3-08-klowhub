  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          'grid min-w-[8rem] items-start gap-1.5 rounded-lg border border-neutral-200 border-neutral-200/50 bg-black px-2.5 py-1.5 text-xs shadow-xl',
          className
        )}
      >
              ...
              >
                {formatter && item?.value !== undefined && item.name ? (
                  ...
                  <>
                    ...
                    <div
                      className={cn('flex flex-1 justify-between gap-x-2', nestLabel ? 'items-end' : 'items-center')}
                    >
                      <div className='grid gap-1.5'>
                        {nestLabel ? tooltipLabel : null}
                        <span className='text-sm text-white'>{itemConfig?.label || item.name}</span>
                      </div>
                      {item.value && (
