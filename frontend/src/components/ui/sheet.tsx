...
const sheetVariants = cva(
  'fixed z-50 gap-4 bg-white p-6 pt-12 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out dark:bg-neutral-950',
  {
    variants: {
      side: {
